...
if(window.location.href == "http://13.233.255.18:8000/"){
    buildList();
}
async function buildList(){
    ...
    var url = "http://13.233.255.18:8000/api/task-list/?"
...
form_wrapper.addEventListener('submit', async (e)=>{
    ...
    var url = "http://13.233.255.18:8000/api/task-create/"
    var title = document.getElementById('title').value;
    const form = document.getElementById('form');

    if(activeItem!=null){
       var url = `http://13.233.255.18:8000/api/task-update/${activeItem.id}/`
       activeItem = null;
    }
...
async function deleteitem(item){
    ...
    var url = `http://13.233.255.18:8000/api/task-delete/${item.id}/`
...
async function strikeUnstrike(item){
    ...
    var url = `http://13.233.255.18:8000/api/task-update/${item.id}/`
